...
const AppSidebar: React.FC = () => {
  ...
  const [openSubmenu, setOpenSubmenu] = useState<{
    type: "overview" | "user_management" | "system";
    index: number;
  } | null>(null);
  ...
  const menuSections: MenuSection[] = useMemo(() => {
    ...
    return sections;
  }, [overviewItems, userManagementItems, systemItems]);
  ...
  const handleSubmenuToggle = (
    index: number,
    menuType: "overview" | "user_management" | "system"
  ) => {
  ...
  useEffect(() => {
    ...
    if (!submenuMatched) {
      ...
      const allItems = [...overviewItems, ...userManagementItems, ...systemItems];
  ...
  }, [pathname, overviewItems, userManagementItems, systemItems]);
